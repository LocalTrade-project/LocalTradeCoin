...
In order to support loading of multiple wallets in localtrade-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is localtrade.cpp.
...
Changes to localtrade.cpp
----------------------
localtrade.cpp is the entry point into localtrade-qt, and as such, will require some minor modifications to provide hooks for
