...
This means one can have an always-on localtraded instance running, and another local localtraded/localtrade-qt instance which connects to this node and receives blocks from it.
