...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LocalTrade Core localtrade-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  localtrade-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded localtrade transaction") + "\n" +
                               "  localtrade-tx [options] -create [commands]   " + _("Create hex-encoded localtrade transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded localtrade transaction
