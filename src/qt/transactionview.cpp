                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received LocalTrade from zLocalTrade"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zLocalTrade"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zLocalTrade));
