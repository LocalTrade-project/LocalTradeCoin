...
/** Utility functions used by the LocalTrade Qt UI.
 */
namespace GUIUtil
{
...
// Render LocalTrade addresses in monospace font
...
// Parse "localtrade:" URI into recipient object, return true on successful parsing
